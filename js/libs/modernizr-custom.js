...
! function (window, document, undefined) {
    ...
    function testProps(A, e, t, n) {
        ...
        for (var o, a, d, s, l, c = ["modernizr", "tspan", "samp"]; !mStyle.style && c.length;) o = !0, mStyle.modElem = createElement(c.shift()), mStyle.style = mStyle.modElem.style;
    ...
    Modernizr.addTest("textshadow", testProp("textShadow", "1px 1px")), testStyles("#modernizr { height: 50vh; }", function (A) {
    ...
    Modernizr.prototype = ModernizrProto, Modernizr = new Modernizr, Modernizr.addTest("applicationcache", "applicationCache" in window), Modernizr.addTest("blobconstructor", function () {
        ...
        return !1
    }), Modernizr.addTest("customevent", "CustomEvent" in window && "function" == typeof window.CustomEvent), Modernizr.addTest("ie8compat", !window.addEventListener && !!document.documentMode && 7 === document.documentMode), Modernizr.addTest("json", "JSON" in window && "parse" in JSON && "stringify" in JSON), Modernizr.addTest("messagechannel", "MessageChannel" in window), Modernizr.addTest("notification", function () {
    ...
    }()), Modernizr.addTest("xhr2", "XMLHttpRequest" in window && "withCredentials" in new XMLHttpRequest), Modernizr.addTest("urlparser", function () {
        var A;
        try {
    ...
    }), Modernizr.addTest("urlsearchparams", "URLSearchParams" in window), Modernizr.addTest("speechsynthesis", "SpeechSynthesisUtterance" in window), Modernizr.addTest("getUserMedia", "mediaDevices" in navigator && "getUserMedia" in navigator.mediaDevices), Modernizr.addTest("atobbtoa", "atob" in window && "btoa" in window, {
        aliases: ["atob-btoa"]
    }), Modernizr.addTest("framed", window.location != top.location), Modernizr.addTest("localstorage", function () {
        var A = "modernizr";
        try {
    ...
    isSVG || ! function (A, e) {
        ...
        function r(A, e) {
            var t = M.elements;
            "string" != typeof t && (t = t.join(" ")), "string" != typeof A && (A = A.join(" ")), M.elements = t + " " + A, s(e)
        }

        function i(A) {
            var e = B[A[D]];
            return e || (e = {}, P++, A[D] = P, B[P] = e), e
        }
        ...
        function o(A, t, n) {
            ...
            n || (n = i(t));
            var r;
            return r = n.cache[A] ? n.cache[A].cloneNode() : h.test(A) ? (n.cache[A] = n.createElem(A)).cloneNode() : n.createElem(A), !r.canHaveChildren || v.test(A) || r.tagUrn ? r : n.frag.appendChild(r)
        }

        function a(A, t) {
            if (A || (A = e), f) return A.createDocumentFragment();
            t = t || i(A);
            for (var r = t.frag.cloneNode(), o = 0, a = n(), d = a.length; d > o; o++) r.createElement(a[o]);
            return r
        }
        ...
        function d(A, e) {
            e.cache || (e.cache = {}, e.createElem = A.createElement, e.createFrag = A.createDocumentFragment, e.frag = e.createFrag()), A.createElement = function (t) {
                return M.shivMethods ? o(t, A, e) : e.createElem(t)
        ...
        function s(A) {
            A || (A = e);
            var n = i(A);
            return !M.shivCSS || p || n.hasCSS || (n.hasCSS = !!t(A, "article,aside,dialog,figcaption,figure,footer,header,hgroup,main,nav,section{display:block}mark{background:#FF0;color:#000}template{display:none}")), f || d(A, n), A
        }

        function l(A) {
            for (var e, t = A.getElementsByTagName("*"), r = t.length, i = RegExp("^(?:" + n().join("|") + ")$", "i"), o = []; r--;) e = t[r], i.test(e.nodeName) && o.push(e.applyElement(c(e)));
            return o
        }

        function c(A) {
            for (var e, t = A.attributes, n = t.length, r = A.ownerDocument.createElement(Q + ":" + A.nodeName); n--;) e = t[n], e.specified && r.setAttribute(e.nodeName, e.nodeValue);
            return r.style.cssText = A.style.cssText, r
        }

        function u(A) {
            for (var e, t = A.split("{"), r = t.length, i = RegExp("(^|[\\s,>+~])(" + n().join("|") + ")(?=[[\\s,>+~#.:]|$)", "gi"), o = "$1" + Q + "\\:$2"; r--;) e = t[r] = t[r].split("}"), e[e.length - 1] = e[e.length - 1].replace(i, o), t[r] = e.join("}");
            return t.join("{")
        }
        ...
        function m(A) {
            function e() {
                clearTimeout(o._removeSheetTimer), n && n.removeNode(!0), n = null
            }
            var n, r, o = i(A),
                a = A.namespaces,
                d = A.parentWindow;
            return !z || A.printShived ? A : ("undefined" == typeof a[Q] && a.add(Q), d.attachEvent("onbeforeprint", function () {
                e();
                for (var i, o, a, d = A.styleSheets, s = [], c = d.length, w = Array(c); c--;) w[c] = d[c];
                for (; a = w.pop();)
                    if (!a.disabled && y.test(a.media)) {
                        try {
                            i = a.imports, o = i.length
                        } catch (m) {
                            o = 0
                        }
                        for (c = 0; o > c; c++) w.push(i[c]);
                        try {
                            s.push(a.cssText)
                        } catch (m) {}
                    }
                ...
                w(r), clearTimeout(o._removeSheetTimer), o._removeSheetTimer = setTimeout(e, 500)
            }), A.printShived = !0, A)
        }
        var p, f, E = "3.7.3",
            g = A.html5 || {},
        ...
        ! function () {
            try {
                ...
                A.innerHTML = "<xyz></xyz>", p = "hidden" in A, f = 1 == A.childNodes.length || function () {
                    e.createElement("a");
        ...
        M.type += " print", M.shivPrint = m, m(e), "object" == typeof module && module.exports && (module.exports = M)
    ...
    ! function () {
        ...
        function A(A, e, t) {
            function n(e) {
                var n = e && "load" === e.type ? 1 == r.width : !1,
                    i = "webp" === A;
                addTest(A, i && n ? new Boolean(n) : n), t && t(e)
            }
            var r = new Image;
        ...
        function e() {
            a && n.revokeObjectURL(a), o && o.terminate(), d && clearTimeout(d)
        }
        try {
            ...
            r || (i = new t, i.append(l), r = i.getBlob()), a = n.createObjectURL(r), o = new Worker(a), o.onmessage = function (A) {
                addTest("blobworkers", s === A.data), e()
            }, o.onerror = A, d = setTimeout(A, 200), o.postMessage(s)
        } catch (c) {
            A()
        }
    }), Modernizr.addAsyncTest(function () {
    ...
    ModernizrProto.hasEvent = hasEvent, Modernizr.addTest("ambientlight", hasEvent("devicelight", window)), Modernizr.addTest("inputsearchevent", hasEvent("search")), Modernizr.addTest("pointerevents", function () {
        var A = !1,
    ...
    Modernizr.addTest("todataurljpeg", function () {
    ...
    }), Modernizr.addTest("textareamaxlength", !!("maxLength" in createElement("textarea"))), Modernizr.addTest("scriptasync", "async" in createElement("script")), Modernizr.addTest("scriptdefer", "defer" in createElement("script")), Modernizr.addAsyncTest(function () {
        function A(o) {
            r++, clearTimeout(e);
            var a = o && "playing" === o.type || 0 !== i.currentTime;
            return !a && n > r ? void(e = setTimeout(A, t)) : (i.removeEventListener("playing", A, !1), addTest("videoautoplay", a), void(i.parentNode && i.parentNode.removeChild(i)))
        }
        var e, t = 200,
            n = 5,
            r = 0,
        ...
        i.setAttribute("autoplay", ""), o.cssText = "display:none", docElement.appendChild(i), setTimeout(function () {
    ...
    }), Modernizr.addTest("stylescoped", "scoped" in createElement("style")), Modernizr.addTest("inlinesvg", function () {
        var A = createElement("div");
    ...
    Modernizr._q.unshift(function () {
        ...
        if (A = !("plugins" in navigator && "Shockwave Flash" in navigator.plugins || e), A || isSVG) r(!1);
            ...
            var o, a, d = createElement("embed"),
                s = getBody();
            if (d.type = "application/x-shockwave-flash", s.appendChild(d), !("Pan" in d || e)) return t(s), r("blocked", d), void n(s);
            o = function () {
                return t(s), docElement.contains(s) ? (docElement.contains(d) ? (a = d.style.cssText, "" !== a ? r("blocked", d) : r(!0, d)) : r("blocked"), void n(s)) : (s = document.body || s, d = createElement("embed"), d.type = "application/x-shockwave-flash", s.appendChild(d), setTimeout(o, 1e3))
            }, setTimeout(o, 10)
        }
